          ...
          {list?.comments?.length ? (
            <div>
              {list?.comments?.map((comment, index) => (
                <article
                  key={index}
                  className="p-6 mb-3 text-base bg-white border-t border-gray-200 dark:border-gray-700 border"
                >
            ...
            <div>
              <h2 className="text-lg lg:text-2xl font-bold text-gray-500 dark:text-white">
                No Comments
              </h2>
            </div>
          )}
