    ...
    <>
      <div className="w-11/12 items-center justify-center mx-auto">
        <div role="status" className="w-full animate-pulse">
          ...
          <div className="h-8 bg-gray-200 rounded-lg dark:bg-gray-700 w-11/12 mb-4"></div>
          ...
          <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-6/12"></div>
          <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-9/12 my-4"></div>
          <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-2/3 mb-2.5"></div>
